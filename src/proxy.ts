...
export default function proxy(request: NextRequest) {
  ...
  response.headers.set('Content-Security-Policy', 
    ...
    "connect-src 'self' https://*.googleapis.com https://*.firebaseio.com wss://*.firebaseio.com https://www.google.com https://apis.google.com https://identitytoolkit.googleapis.com https://api.razorpay.com https://cdn.razorpay.com https://checkout.razorpay.com https://*.razorpay.com https://*.google-analytics.com https://*.analytics.google.com https://*.googletagmanager.com https://*.clarity.ms https://www.clarity.ms https://*.firebaseapp.com https://*.firebase.com " +
