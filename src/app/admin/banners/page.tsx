...
import { Plus, Edit, Trash2, Eye, EyeOff, ArrowLeft, Image as ImageIcon, Upload, X, Loader2, Shield } from 'lucide-react'
    ...
    <div className="min-h-screen bg-gradient-to-br from-gray-50 via-purple-50 to-pink-50">
      <div className="container mx-auto px-4 py-8">
        <div className="max-w-6xl mx-auto">
          {/* Header */}
          <div className="mb-8">
            <Link href="/admin/dashboard" className="inline-flex items-center text-gray-600 hover:text-purple-600 mb-4 group transition-colors">
            ...
            <h1 className="text-3xl md:text-4xl font-bold mb-2">
              <span className="bg-gradient-to-r from-purple-600 to-pink-600 bg-clip-text text-transparent">Manage Banners</span>
            </h1>
